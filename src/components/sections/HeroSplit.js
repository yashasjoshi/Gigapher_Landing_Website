        ...
        <div className={innerClasses}>
          <div className={splitClasses}>
            <div className="split-item ">
              <div className="split-item-content-f center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                <div className="text-xxs text-color-primary fw-600 tt-u mb-8 ">
                  </div>
                  <h2 className=" reveal-from-top" data-reveal-delay="200">
                    <br/>Discover, Collect, and Sell <span className="text-color-primary">Real Estate NFTs</span>
                  </h2>
                  <p className="m-0 mb-32 reveal-from-top" data-reveal-delay="400">
                    World's first, largest, and one of a kind Real Estate NFT Marketplace
                  </p>
              ...
              <div className={
                classNames(
                  'split-item-image-f center-content-mobile reveal-from-right ml--200px',
                  imageFill && 'split-item-image-fill'
                )} data-reveal-delay="200"
                data-reveal-container=".split-item">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      height="99vh" viewBox="0 0 1500 900" enableBackground="new 0 0 2000 1200" xmlSpace="preserve">
      <g>
      ...
      <g>
          <g>
              <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="-26" y1="616" x2="2010" y2="616">
                  <stop offset="0" className="stopColor202333" />
                  <stop offset="1" className="stopColor5C1B99" />
              </linearGradient>
              <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="-101.1755" y1="174.3284" x2="2085.1755" y2="1057.6716">
                  <stop offset="0" className="stopColor202333" />
                  <stop offset="1" className="stopColor5C6399" />
              </linearGradient>
...
SUVORK5CYII=" transform="matrix(0.9846 0 0 0.9846 841.9875 782.9567)">
                  ...
                  <g display="inline">
                      ...
                      <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="867.5721" y1="380.1925" x2="884.255" y2="390.742" gradientTransform="matrix(1 0 0 -1 0 1200)">
                          <stop offset="0" className="stopColorFFFFFF" />
                          <stop offset="0.8387" className="stopColorFO" />
                      </linearGradient>
          ...
          <g id="d-appswrapper">
              <g id="d-app">
                  <g>
                      ...
                      <linearGradient id="SVGID_7_" gradientUnits="userSpaceOnUse" x1="596.2948" y1="1492.3506" x2="531.7549" y2="1455.0885" gradientTransform="matrix(1 0 0 -1 0 1900)">
                          <stop offset="0" className="stopColor808080" />
                          <stop offset="0.2627" className="stopColor6F6F6F" />
                          <stop offset="0.7192" className="stopColor575757" />
                          <stop offset="1" className="stopColor4E4E4E" />
                      </linearGradient>
                  ...
                  L610,435c0,0,2.3-1.4,2.5-3.4C612.8,430,612.7,430.1,612.3,427.9z" />
                      ...
                      <linearGradient id="SVGID_8_" gradientUnits="userSpaceOnUse" x1="536.1459" y1="1498.0173" x2="577.0236" y2="1439.6381" gradientTransform="matrix(1 0 0 -1 0 1900)">
                          <stop offset="0" className="stopColor9A9A9A" />
                          <stop offset="0.3122" className="stopColor9F9F9F" />
                          <stop offset="0.7197" className="stopColorB0B0B0" />
                          <stop offset="1" className="stopColorBFBFBF" />
                      </linearGradient>
                  ...
                  <g>
                      ...
                      <linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="596.3016" y1="1506.1545" x2="524.3275" y2="1464.6003" gradientTransform="matrix(1 0 0 -1 0 1900)">
                          <stop offset="0" className="stopColorA61D30" />
                          <stop offset="0.2302" className="stopColorAA2033" />
                          <stop offset="0.4367" className="stopColorB4293A" />
                          <stop offset="0.634" className="stopColorC73848" />
                          <stop offset="0.8245" className="stopColorE04D5A" />
                          <stop offset="1" className="stopColorFF6670" />
                      </linearGradient>
                  ...
                  l47.6-28.3c0,0,2.3-1.4,2.5-3.4C612.8,416.2,612.7,416.3,612.3,414.1z" />
                      ...
                      <linearGradient id="SVGID_10_" gradientUnits="userSpaceOnUse" x1="536.1385" y1="1511.8278" x2="577.0161" y2="1453.4487" gradientTransform="matrix(1 0 0 -1 0 1900)">
                          <stop offset="0" className="stopColorE6455C" />
                          <stop offset="1" className="stopColorFF3D49" />
                      </linearGradient>
              ...
              <g>
                  ...
                  <linearGradient id="SVGID_13_" gradientUnits="userSpaceOnUse" x1="554.679" y1="1464.3314" x2="554.679" y2="1574.4468" gradientTransform="matrix(1 0 0 -1 0 1900)">
                      <stop offset="0" className="stopColorFO" />
                      <stop offset="0.291" className="stopColorFFFFFF" />
                      <stop offset="0.9975" className="stopColorFO" />
                  </linearGradient>
          ...
          <g id="topgreyblocks" opacity="0.7">
              <g>
                  ...
                  <linearGradient id="SVGID_14_" gradientUnits="userSpaceOnUse" x1="947.494" y1="880.5922" x2="990.4099" y2="903.5613" gradientTransform="matrix(1 1.170540e-04 1.170540e-04 -1 -1.549590e-02 1199.7689)">
                      <stop offset="0" className="stopColor262626" />
                      <stop offset="0.2774" className="stopColor2F2F2F" />
                      <stop offset="0.7283" className="stopColor474747" />
                      <stop offset="1" className="stopColor595959" />
                  </linearGradient>
                  ...
                  <linearGradient id="SVGID_15_" gradientUnits="userSpaceOnUse" x1="997.8663" y1="909.6794" x2="1033.5619" y2="873.9838" gradientTransform="matrix(1 1.170540e-04 1.170540e-04 -1 -1.549590e-02 1199.7689)">
                      <stop offset="0" className="stopColorBFBFBF" />
                      <stop offset="0.2132" className="stopColor969696" />
                      <stop offset="0.4462" className="stopColor717171" />
                      <stop offset="0.6625" className="stopColor565656" />
                      <stop offset="0.8538" className="stopColor464646" />
                      <stop offset="1" className="stopColor404040" />
                  </linearGradient>
                  ...
                  <linearGradient id="SVGID_16_" gradientUnits="userSpaceOnUse" x1="980.2971" y1="911.2566" x2="1008.4671" y2="955.3561" gradientTransform="matrix(1 1.170540e-04 1.170540e-04 -1 -1.549590e-02 1199.7689)">
                      <stop offset="0" className="stopColorBFBFBF" />
                      <stop offset="0.219" className="stopColorA2A2A2" />
                      <stop offset="0.5607" className="stopColor7B7B7B" />
                      <stop offset="0.833" className="stopColor636363" />
                      <stop offset="1" className="stopColor5A5A5A" />
                  </linearGradient>
                  ...
                  <linearGradient id="SVGID_17_" gradientUnits="userSpaceOnUse" x1="1010.6151" y1="921.8813" x2="1020.1381" y2="912.3583" gradientTransform="matrix(1 1.170540e-04 1.170540e-04 -1 -1.549590e-02 1199.7689)">
                      <stop offset="0" className="stopColorFFFFFF" />
                      <stop offset="0.2961" className="stopColorD3D3D3" />
                      <stop offset="0.604" className="stopColorABABAB" />
                      <stop offset="0.8495" className="stopColor939393" />
                      <stop offset="1" className="stopColor8A8A8A" />
                  </linearGradient>
...
RK5CYII=" transform="matrix(0.98 0 0 0.98 590.2817 497.2417)">
          ...
          <g id="redglow">
              <linearGradient id="SVGID_41_" x1="885.7858" x2="885.9467" y1="-920.6589" y2="-787.5014" gradientTransform="matrix(0.3592 -0.3065 1.2019 0.6834 1339.3929 1550.1232)"
                  ...
                  <stop offset="0" className="stopColorFO" />
                  <stop offset="1" className="stopColorFFFFFF" />
              </linearGradient>
      ...
      555.6,608.9 		" enableBackground="new    " opacity="0.25" />
              <linearGradient id="SVGID_42_" x1="1042.4587" x2="993.0236" y1="-985.6109" y2="-790.8901" gradientTransform="matrix(0.3592 -0.3065 1.2019 0.6834 1339.3929 1550.1232)"
                  gradientUnits="userSpaceOnUse">
                  <stop offset="0" className="stopColorFO" />
                  <stop offset="0.2113" className="stopOpacityFFD7DA" />
                  <stop offset="0.4448" className="stopOpacityFFB1B8" />
                  <stop offset="0.6617" className="stopOpacityFF969F" />
                  <stop offset="0.8535" className="stopOpacityFF8690" />
                  <stop offset="1" className="stopColorFF808B" />
              </linearGradient>
      ...
      556,537.9 		" enableBackground="new    " opacity="0.75" />
              ...
              <linearGradient id="SVGID_43_" x1="891.1575" x2="874.2567" y1="-968.8058" y2="-817.3937" gradientTransform="matrix(0.3592 -0.3065 1.2019 0.6834 1339.3929 1550.1232)"
                  gradientUnits="userSpaceOnUse">
                  <stop offset="7.030000e-02" className="stopColorFO" />
                  <stop offset="1" className="stopColorFFFFFF" />
              </linearGradient>
          ...
          <g id="redblocksparticles">
              <g>
                  <linearGradient id="SVGID_91_" x1="3650.8601" x2="3659.948" y1="114.5993" y2="168.2118" gradientTransform="matrix(-0.3592 -0.3065 -1.2019 0.6834 2623.3687 1550.1232)"
                      gradientUnits="userSpaceOnUse">
                      <stop offset="0" className="stopOpacityFFB3B7" />
                      <stop offset="1" className="stopColorFFB3B7" />
                  </linearGradient>
          ...
          <g>
              <g opacity="0.25">
                  <linearGradient id="SVGID_46_" x1="1460.7068" x2="1522.7059" y1="-405.4163" y2="-438.5989" gradientTransform="matrix(1 0 0 1 0 700)"
                      gradientUnits="userSpaceOnUse">
                      <stop offset="0" className="stopColor494949" />
                      <stop offset="0.4259" className="stopColor525252" />
                      <stop offset="1" className="stopColor656565" />
                  </linearGradient>
                  ...
                  <linearGradient id="SVGID_47_" x1="1533" x2="1584.1" y1="-447.2" y2="-396.1" gradientTransform="matrix(1 0 0 1 0 700)" gradientUnits="userSpaceOnUse">
                      <stop offset="0" className="stopColorB8B8B8" />
                      <stop offset="5.310000e-02" className="stopColorB0B0B0" />
                      <stop offset="0.3337" className="stopColor8B8B8B" />
                      <stop offset="0.5939" className="stopColor707070" />
                      <stop offset="0.8241" className="stopColor5F5F5F" />
                      <stop offset="1" className="stopColor5A5A5A" />
                  </linearGradient>
                  ...
                  <linearGradient id="SVGID_48_" x1="1507.2352" x2="1547.9783" y1="-450.4547" y2="-514.2369" gradientTransform="matrix(1 0 0 1 0 700)"
                      gradientUnits="userSpaceOnUse">
                      <stop offset="0" className="stopColor787878" />
                      <stop offset="0.5984" className="stopColor636363" />
                      <stop offset="1" className="stopColor5A5A5A" />
                  </linearGradient>
      ...
      l-0.8-1.3L1524.4,178.1z" />
          ...
          <g id="firstBlock">
              <linearGradient id="SVGID_49_" x1="1299.6068" x2="1361.6029" y1="-311.3163" y2="-344.4973" gradientTransform="matrix(1 0 0 1 0 700)"
                  gradientUnits="userSpaceOnUse">
                  <stop offset="0" className="stopColorA91B37" />
                  <stop offset="0.2857" className="stopColorB21F37" />
                  <stop offset="0.75" className="stopColorCA2B38" />
                  <stop offset="1" className="stopColorDA3239" />
              </linearGradient>
              ...
              <linearGradient id="SVGID_50_" x1="1372.5" x2="1424.6" y1="-353.6" y2="-301.5" gradientTransform="matrix(1 0 0 1 0 700)"
                  gradientUnits="userSpaceOnUse">
                  <stop offset="0" className="stopColorFF999F" />
                  <stop offset="0.1701" className="stopColorF27B85" />
                  <stop offset="0.4158" className="stopColorE35566" />
                  <stop offset="0.6441" className="stopColorD73A4F" />
                  <stop offset="0.8458" className="stopColorD02A41" />
                  <stop offset="1" className="stopColorCE243C" />
              </linearGradient>
              ...
              <linearGradient id="SVGID_51_" x1="1347.0559" x2="1388.1415" y1="-355.8673" y2="-420.1857" gradientTransform="matrix(1 0 0 1 0 700)"
                  gradientUnits="userSpaceOnUse">
                  <stop offset="0" className="stopColorE64852" />
                  <stop offset="5.850000e-02" className="stopColorE44550" />
                  <stop offset="0.6415" className="stopColorD42D41" />
                  <stop offset="1" className="stopColorCE243C" />
              </linearGradient>
              ...
              <linearGradient id="SVGID_52_" x1="1390.3" x2="1404.4501" y1="-371.4" y2="-357.25" gradientTransform="matrix(1 0 0 1 0 700)"
                  gradientUnits="userSpaceOnUse">
                  <stop offset="0" className="stopColorFFFFFF" />
                  <stop offset="0.2713" className="stopColorFDC8BA" />
                  <stop offset="0.5184" className="stopColorFB9C83" />
                  <stop offset="0.7299" className="stopColorF97C5B" />
                  <stop offset="0.8974" className="stopColorF86843" />
                  <stop offset="1" className="stopColorF8613A" />
              </linearGradient>
...
CzAAqYTVOPWO2yYAAAAASUVORK5CYII=" transform="matrix(0.98 0 0 0.98 1024.2817 776.2417)">
          ...
          <g>
              <circle r="1" className="fill_fff" opacity="4gf.2">
              ...
              <circle r="1" className="fill_fff" opacity="04gf2">
              ...
              <circle r="1" className="fill_fff" opacity="0.4gf">
          ...
          <g id="bottomblocks" opacity="0.7">
              <g>
                  <g opacity="0.25">
                      ...
                      <linearGradient id="SVGID_126_" gradientUnits="userSpaceOnUse" x1="1652.4972" y1="450.1895" x2="1679.3896" y2="464.5827"
                          ...
                          <stop offset="0" className="stopColor494949" />
                          <stop offset="0.2255" className="stopColor525252" />
                          <stop offset="0.593" className="stopColor6A6A6A" />
                          <stop offset="1" className="stopColor8C8C8C" />
                      </linearGradient>
                      ...
                      <linearGradient id="SVGID_128_" gradientUnits="userSpaceOnUse" x1="1673.0768" y1="469.5625" x2="1690.5178" y2="496.8659"
                          gradientTransform="matrix(1 0 0 -1 0 1200)">
                          <stop offset="0" className="stopColorA6A6A6" />
                          <stop offset="3.360000e-02" className="stopColorA2A2A2" />
                          <stop offset="0.4566" className="stopColor7B7B7B" />
                          <stop offset="0.7934" className="stopColor636363" />
                          <stop offset="1" className="stopColor5A5A5A" />
                      </linearGradient>
                  ...
                  <linearGradient id="SVGID_129_" gradientUnits="userSpaceOnUse" x1="1709.9064" y1="447.7885" x2="1652.8374" y2="483.866" gradientTransform="matrix(1 0 0 -1 0 1200)">
                      <stop offset="0" className="stopColor3A3C4D" />
                      <stop offset="0.42" className="stopColor3D3F4E" />
                      <stop offset="0.7058" className="stopColor464752" />
                      <stop offset="0.9509" className="stopColor555557" />
                      <stop offset="1" className="stopColor595959" />
                  </linearGradient>
              ...
              C1525.1,794.8,1525.1,794.8,1525.1,794.9z M1523.4,795.9l0.3,0.6l0.6-0.4l-0.3-0.6L1523.4,795.9z" />
                  ...
                  <linearGradient id="SVGID_134_" gradientUnits="userSpaceOnUse" x1="1553.097" y1="420.8045" x2="1662.411" y2="420.8045" gradientTransform="matrix(1 0 0 -1 0 1200)">
                      <stop offset="0" className="stopColorBFBFBF" />
                      <stop offset="0.1122" className="stopColorAAAAAE" />
                      <stop offset="0.4064" className="stopColor767884" />
                      <stop offset="0.6631" className="stopColor515366" />
                      <stop offset="0.8695" className="stopColor3A3D54" />
                      <stop offset="1" className="stopColor32354D" />
                  </linearGradient>
              ...
              <g>
                  ...
                  <linearGradient id="SVGID_143_" gradientUnits="userSpaceOnUse" x1="1234.4193" y1="157.2996" x2="1178.0508" y2="192.9343"
                      gradientTransform="matrix(1 0 0 -1 0 1200)">
                      <stop offset="0" className="stopColor595959" />
                      <stop offset="4.910000e-02" className="stopColor555557" />
                      <stop offset="0.2942" className="stopColor464752" />
                      <stop offset="0.58" className="stopColor3D3F4E" />
                      <stop offset="1" className="stopColor3A3C4D" />
                  </linearGradient>
              ...
              <linearGradient id="SVGID_145_" gradientUnits="userSpaceOnUse" x1="1179.2999" y1="193.9759" x2="969.9731" y2="325.7959" gradientTransform="matrix(1 0 0 -1 0 1200)">
                  <stop offset="0" className="stopColor32354D" />
                  <stop offset="0.1305" className="stopColor3A3D54" />
                  <stop offset="0.3369" className="stopColor515366" />
                  <stop offset="0.5936" className="stopColor767884" />
                  <stop offset="0.8878" className="stopColorAAAAAE" />
                  <stop offset="1" className="stopColorBFBFBF" />
              </linearGradient>
          ...
          l0.8-1.2l-2.8-1.8l-0.8,1.2L1447.2,588.7z" />
              ...
              <path id="bottomline" d="m969.4 873.9 241.4 151.8 291.8-184.6 177.5-105.4-241.9-153.4" className="bottomLine"
              />
          ...
          <g>
              ...
              <linearGradient id="SVGID_147_" gradientUnits="userSpaceOnUse" x1="605.9249" y1="953.613" x2="606.0892" y2="817.645" gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)">
                  <stop offset="0" className="stopColorFFFFFF" />
                  <stop offset="1" className="stopColorFO" />
              </linearGradient>
          ...
          955,672.8 		" />
              ...
              <linearGradient id="SVGID_148_" gradientUnits="userSpaceOnUse" x1="763.4714" y1="1027.7656" x2="725.6356" y2="878.7339" gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)">
                  <stop offset="0" className="stopColorFF808B" />
                  <stop offset="0.3874" className="stopOpacityFFB2B9" />
                  <stop offset="0.9388" className="stopColorFO" />
              </linearGradient>
          ...
          954.8,596.8 		" />
              ...
              <linearGradient id="SVGID_149_" gradientUnits="userSpaceOnUse" x1="608.2545" y1="1006.7597" x2="591.3518" y2="855.3317" gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)">
                  <stop offset="0" className="stopColorFFFFFF" />
                  <stop offset="0.1993" className="stopOpacityC5C6D1" />
                  <stop offset="0.3919" className="stopOpacity9497AB" />
                  <stop offset="0.5731" className="stopOpacity6E728D" />
                  <stop offset="0.7399" className="stopOpacity535878" />
                  <stop offset="0.8874" className="stopOpacity43486B" />
                  <stop offset="1" className="stopColor3D4266" />
              </linearGradient>
          ...
          1272.8,407.8 		" />
              ...
              <linearGradient id="SVGID_154_" gradientUnits="userSpaceOnUse" x1="1332.3284" y1="958.5676" x2="1315.4257" y2="807.1397"
                  gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)">
                  <stop offset="0" className="stopColorFFFFFF" />
                  <stop offset="8.269999e-02" className="stopOpacityE2E2E5" />
                  <stop offset="0.2656" className="stopOpacityA8A9AF" />
                  <stop offset="0.4423" className="stopOpacity777983" />
                  <stop offset="0.6084" className="stopOpacity515460" />
                  <stop offset="0.7614" className="stopOpacity363947" />
                  <stop offset="0.8967" className="stopOpacity262938" />
                  <stop offset="1" className="stopOpacity202333" />
              </linearGradient>
